...
class PhoneCall : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_call.setOnClickListener{
             ...
             * 이때, 시스템에 권한이 있어야 실제 전화를 걸수있다.
             *
             * 안드로이드 API 23 Level(마시멜로) 이상에서는 반드시 의무적으로
             ...
             * 이런경우 test 를 위하여
             * 임의로(수동으로) 설정 -> 앱 -> 해당 어플 -> 전화 권한을 허용 해줘야한다
             * 그리고 Manifest.xml 에 uses-permission 항목에 CALL_PHONE 을 등록해야 한다
             */
             ...
             *          이럴때는 프로젝트의 액티비티를 service 로 등록한다
             *      - 네트워크 서버와 연동하기도 한다
             *      - 어플이 종료되어도 서비스는 강제 종료 되지 않는다
             *
