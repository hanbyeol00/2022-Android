...
import com.hanbyeol.hello2.R
import com.hanbyeol.hello2.databinding.ActivityMainBinding

/**
 * class 는 Kotlin 에서 사용하는 모듈 구조
 * class 는 객체지향 프로그래밍의 기본 모듈 단위
 * 객채지향 프로그래밍에서는 다른 클래스의 기능을 상속 확장(extends)하여
 * 일부 기능을 별도로 구형할 수 있다
 */
class MainActivity : AppCompatActivity() {
    ...
    /**
     * override fun
     * MainActivity 가 상속받은 AppCompatActivity(부모 클래스) 클래스에서 정의해 놓은 함수
