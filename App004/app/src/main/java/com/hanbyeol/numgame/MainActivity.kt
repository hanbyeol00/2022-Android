...
import com.hanbyeol.numgame.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
     ...
     * 원칙이다. 하지만 경우데 따라 선언부와 초기화 코드를 분리하고 할때
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // 1 부터 20 까지 정수중에서 임의 숫자 한개를 추출하여
        // rndNumber 에 저장하라
        ...
        binding.textNumber.setOnEditorActionListener{view,keyCode,event ->

            // input 입력된 문자열 추출
            val number = binding.textNumber.text.toString()
