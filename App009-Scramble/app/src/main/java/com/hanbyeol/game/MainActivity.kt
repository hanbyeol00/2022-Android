...
import com.hanbyeol.game.databinding.ActivityMainBinding
import com.hanbyeol.game.ui.FRAGMENT_MAIN
import com.hanbyeol.game.ui.FRAGMENT_RESULT
import com.hanbyeol.game.ui.MainFragment
import com.hanbyeol.game.ui.ResultFragment
...
class MainActivity : AppCompatActivity() {
    ...
    /**
     * Activity -> Fragment 의 계층 구조로 만들어진 UI 구조에서
     * Activity 아래의 다수의 Fragment 가 서로 화면을 교환하고자 할때
     * Fragment 들 간은 형제간 이기 때문에 현제끼리 교환이 불가능 하다
